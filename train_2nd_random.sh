...
python3 fairseq_cli/train.py \
    ...
    --max-tokens 2000 --update-freq 2 \
    --log-interval 100 \
    --save-dir model_2nd_random_pos_wise/ \
    --keep-last-epochs 1 \
    ...
    --seed 1111 \
    --tensorboard-logdir tb_2nd_random_pos_wise/
